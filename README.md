...
<header>🔥 Survivor Live Snake Draft 🔥</header>

<div class="container">

<div id="setup">
<input type="text" id="roomId" placeholder="Enter Draft Room Name">
<input type="number" id="teamCount" min="5" max="8" placeholder="Number of Teams (5–8)">
...
function updateTurn() {
  ...
  document.getElementById("turnDisplay").innerHTML =
    `<span class="current-turn">Round ${round+1} — ${roomData.teams[snakeIndex]} picking</span>`;
}
